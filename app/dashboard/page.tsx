...
import { getProjectsForDashboard, type DashboardProject } from "@/lib/services/project-service"
...
export default function DashboardPage() {
    ...
    }, [projects, searchTerm, categoryFilter, tagFilter, statusFilter, extensionFilter, yearFilter])
    ...
    const insights = useMemo(() => {
        ...
        filteredProjects.forEach(p => {
            ...
            countryInvestment[country] = (countryInvestment[country] || 0) + (Number(p.investment) || 0)
        })
        ...
        filteredProjects.forEach(p => {
            institutionInvestment[p.institution] = (institutionInvestment[p.institution] || 0) + (Number(p.investment) || 0)
        })
                                    ...
                                    <CardContent>
                                        ...
                                        <div className="space-y-2 text-sm text-muted-foreground">
                                            ...
                                            <div className="pt-2 border-t mt-3 flex justify-between items-center">
                                                <span className="font-semibold text-foreground">{formatCurrency(Number(project.investment) || 0)}</span>
