...
// Ensure contrasting text color for backgrounds
...
export default function SettingsPage() {
  ...
  const handleAddCategory = async () => {
    ...
    const result = await createCategory(newCategory, newCategoryColor);
    if (result.success) {
      ...
      toast.error(result.error || "Erro ao adicionar categoria");
    }
  };
  ...
  const handleAddTag = async () => {
    ...
    const result = await createTag(newTag, newTagColor);
    if (result.success) {
