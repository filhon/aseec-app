        ...
        <div className="space-y-6">
          ...
          <div className="p-1">
            <FinancialCards
              ...
              predictedBalance={158000.0}
              totalRevenue={450000.0}
              totalExpenses={307500.0}
            />
          </div>
            ...
            {[
              ...
              <Card
                ...
                onClick={() =>
                  onInsightClick(
                    "Projetos",
                    `Detalhes sobre o projeto ${proj.name}`,
                  )
                }
              >
                <CardContent className="p-4 flex items-center gap-4">
                  <div
                    className={`w-2 h-12 rounded-full ${proj.color.split(" ")[1]}`}
                  />
                  <div className="flex-1">
                    <div className="flex justify-between items-center mb-1">
                      <h3 className="font-semibold">{proj.name}</h3>
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded-full bg-muted ${proj.color.split(" ")[0]}`}
                      >
                        {proj.status}
                      </span>
                    </div>
                    <div className="w-full bg-muted h-2 rounded-full overflow-hidden">
                      <div
                        className={`h-full ${proj.color.split(" ")[1]}`}
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Alertas críticos e planos de mitigação.
              </p>
            </div>
            <Button
              variant="outline"
              ...
              onClick={() =>
                onInsightClick(
                  "Riscos",
                  "Gere um relatório de mitigação para os riscos críticos.",
                )
              }
            >
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="border-l-4 border-l-red-500">
              ...
              <CardContent>
                <p className="text-sm mb-4">
                  Mudanças na legislação local podem impactar o cronograma da
                  obra em 3 meses.
                </p>
                <Button
                  variant="secondary"
                  ...
                  onClick={() =>
                    onInsightClick(
                      "Riscos",
                      "Plano de ação para Risco Regulatório Sul",
                    )
                  }
                >
            ...
            <Card className="border-l-4 border-l-yellow-500">
              ...
              <CardContent>
                <p className="text-sm mb-4">
                  Atraso na entrega de servidores pode adiar a migração do ERP.
                </p>
                <Button
                  variant="secondary"
                  size="sm"
                  ...
                  onClick={() =>
                    onInsightClick(
                      "Riscos",
                      "Alternativas para o fornecedor de TI",
                    )
                  }
                >
                  Ver Alternativas
