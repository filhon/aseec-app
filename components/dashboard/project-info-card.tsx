...
export function ProjectInfoCard({
  ...
  return (
    <Card
      className={`transition-all duration-300 ${isEditing ? "ring-2 ring-primary border-primary" : ""}`}
    >
              ...
              <DialogContent>
                ...
                <div className="py-4 text-center text-muted-foreground">
                  <div className="flex flex-col items-center gap-2 opacity-50">
                    ...
                    <p>
                      Simulação: Aqui seriam exibidas as versões anteriores
                      deste bloco de dados.
                    </p>
                  </div>
                </div>
              </DialogContent>
