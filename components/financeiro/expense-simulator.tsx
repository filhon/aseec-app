        ...
        <div className="w-full space-y-4">
          ...
          >
            {simulationResult ? (
              ...
              <span>
                Preencha os campos acima para ver o resultado da análise.
              </span>
            )}
          </div>
              ...
              <table className="w-full text-xs">
                ...
                <tbody className="bg-card">
                  {simulationResult.installments.map((inst) => (
                    <tr
                      key={inst.number}
                      className="border-t last:border-0 hover:bg-muted/50 transition-colors"
                    >
